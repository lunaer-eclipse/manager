...
while true; do
    ...
    while IFS=: read -r user pass expiry limit bandwidth_gb daily_bandwidth_gb _extra; do
        ...
        if $dynamic_banners_enabled; then
            ...
            banner_content="<br><font color="red"><b> 𝘼𝙈𝙊𝙆𝙃𝘼𝙉-𝙎𝙎𝙃 𝙈𝘼𝙉𝘼𝙂𝙀𝙍 𝙑7-𝙐𝙡𝙩𝙧𝙖 </b></font><br>
            banner_content="<br><font color"yellow"><b>      ✨ 𝔸ℂℂ𝕆𝕌ℕ𝕋 𝕊𝕋𝔸𝕋𝕌𝕊 ✨      </b></font><br><br>"
            banner_content+="<font color="white">👤 <b>𝙐𝙨𝙚𝙧𝙣𝙖𝙢𝙚   :</b> $user</font><br>"
            banner_content+="<font color="blue">📅 <b>𝙀𝙭𝙥𝙞𝙧𝙩𝙞𝙤𝙣 :</b> $expiry ($days_left)</font><br>"
            
            if [[ "$bandwidth_gb" != "0" ]]; then
                banner_content+="<font color="green">📊 <b>𝙏𝙤𝙩𝙖𝙡 𝘽𝙒   :</b> $bw_info</font><br>"
            fi
            ...
            if [[ "$daily_bandwidth_gb" != "0" ]]; then
                ...
                banner_content+="<font color="cyan">📊 <b>𝑫𝒂𝒊𝒍𝒚 𝑩𝑾   :</b> $daily_bw_info</font><br>"
            fi
            
            banner_content+="<font color="purple">🔌 <b>𝙎𝙚𝙨𝙨𝙞𝙤𝙣   :</b> $online_count/$limit</font><br><br>"
...
install_udp_custom() {
    ...
    local binary_url=""
    if [[ "$arch" == "x86_64" ]]; then
        binary_url="https://raw.githubusercontent.com/lunaer-eclipse/manager/main/udp/udp-custom-linux-amd64"
        echo -e "${C_BLUE}ℹ️ Detected x86_64 (amd64) architecture.${C_RESET}"
    elif [[ "$arch" == "aarch64" || "$arch" == "arm64" ]]; then
        binary_url="https://raw.githubusercontent.com/lunaer-eclipse/manager/main/udp/udp-custom-linux-arm"
